  ...
  return (
    <div className="py-16 bg-gray-50">
      ...
      <div className='flex gap-6 px-36'>
        <div className="bg-blue-100 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="bg-green-100 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="bg-purple-100 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="bg-orange-100 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">

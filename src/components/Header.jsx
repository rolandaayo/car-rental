  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between px-4 md:px-8 pt-16 md:pt-40 max-w-7xl mx-auto">
      <div className="flex-1 pr-0 md:pr-12 text-center md:text-left mb-8 md:mb-0 w-full md:w-auto pt-8 md:pt-0">
        ...
        <p className="text-base sm:text-lg md:text-xl font-montserrat text-gray-600 mb-6">Live in New York, New Jersey and Connecticut!</p>
        ...
        <div className="mt-6 md:mt-8 flex flex-col sm:flex-row gap-3 md:gap-4">
          <button className="w-full sm:w-auto bg-blue-600 text-white px-4 sm:px-6 md:px-8 py-2.5 md:py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-lg text-xs sm:text-sm md:text-base animate-bounce">
            Get Started
          </button>
